...
func initialize(_inventory_data: InventoryData) -> void:
	...
	inventory_data.on_item_moved.connect(func (): refresh())
	inventory_data.on_item_added.connect(func (slot): refresh())
	inventory_data.on_item_dropped.connect(func (slot): refresh())
	inventory_data.on_item_removed.connect(func (slot): refresh())
	inventory_data.on_item_used.connect(func (x): refresh())
	inventory_data.on_slot_selected.connect(func (slot_index): refresh())
